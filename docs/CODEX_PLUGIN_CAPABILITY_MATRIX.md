...
| Research workflow | `/revela research`, research-save tool | `revela-research` skill + active domain read + `revela_research_save`; for deck goals, Planning Handoff reads active design inventory and writes validated `deck-plan.md` | Tool-backed MVP |
