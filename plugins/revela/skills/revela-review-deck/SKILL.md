...
7. Content changes that affect the deck argument should update `deck-plan/` first, then remake the deck.

## QA Notes

- `revela_review_deck_read` is read-only: it must not mutate deck HTML, `deck-plan/`, assets, or compatibility state.
