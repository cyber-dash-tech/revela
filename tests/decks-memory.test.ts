...
describe("buildInitPrompt", () => {
  ...
  it("does not make deck render inputs mandatory during narrative init", () => {
    ...
    expect(prompt).toContain("fix `markdownQa.repairCards`")
    ...
    expect(prompt).toContain("write relation lines under the existing `## Relations` section after checking inventory")
