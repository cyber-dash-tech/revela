...
describe("buildInitPrompt", () => {
  ...
  it("does not make deck render inputs mandatory during narrative init", () => {
    ...
    expect(prompt).toContain("Add graph edges afterward through `revela-narrative/relations.md`")
    expect(prompt).toContain("Do not add new `## Relations` sections")
    expect(prompt).toContain("New graph relations belong in `revela-narrative/relations.md`")
...
describe("research command", () => {
  it("builds a tool-driven research and binding prompt", () => {
    ...
    expect(prompt).toContain("then add explicit edges through `revela-narrative/relations.md`")
    expect(prompt).toContain("Do not add new inline `## Relations` sections")
