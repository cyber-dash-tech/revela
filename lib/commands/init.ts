...
8. If enough information is available, preserve canonical narrative intent. When \`revela-narrative/\` exists, edit the relevant Markdown nodes and then call \`revela-decks\` action \`compileNarrativeVault\`; otherwise use \`revela-decks\` action \`upsertNarrative\` for audience intent, decision intent, thesis, central claims, explicit evidence bindings where known, objections, and risks. This does not require deck rendering inputs.
