...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，use summit as design.
...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，列出 available domains。
...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，use consulting as domain.
...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，创建一个名为 neon-finance 的新 design：金融仪表盘风格，深色界面、精密网格、亮绿色重点色。
...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，使用 neon-finance 作为 design。

4. 初始化本地 material intake。Init 会扫描、抽取并审阅 workspace source；它不会创建 Narrative Vault。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，帮我 init 这个 workspace，先读本地材料。

5. 针对 deck 所需输入做 research，并保存带来源的 findings。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，research 这个 deck 需要的公开证据、案例和 source。

6. 先创建或更新 deck plan，明确 slide 顺序、章节结构、source links、unresolved inputs、source limitations 和 visual intent，再生成 HTML。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，生成 HTML 前先 create or update deck plan。

7. 基于当前 deck plan 生成 HTML deck。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，基于当前 deck plan make deck。
...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，把 deck export 成 PDF。

10. QA 通过后导出可编辑 PPTX。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，把 deck export 成 PPTX。

11. QA 通过后导出每页 PNG。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.5/skills/revela/SKILL.md)，把 deck export 成 PNG。
