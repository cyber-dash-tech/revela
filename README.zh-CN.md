...
> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.8/skills/revela/SKILL.md)，把 deck export 成 PDF。

10. QA 通过后导出可编辑 PPTX。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.8/skills/revela/SKILL.md)，把 deck export 成 PPTX。

11. QA 通过后导出每页 PNG。

> [$revela:revela](/Users/mengdigao/.codex/plugins/cache/revela/revela/0.19.8/skills/revela/SKILL.md)，把 deck export 成 PNG。
